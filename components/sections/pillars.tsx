...
export function Pillars() {
  return (
    <section
      id="pillars"
      className="relative overflow-hidden bg-[#06164f] section-y"
    >
      <div
        aria-hidden
        className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.045),transparent_52%)]"
      />
        ...
        <Stagger className="mx-auto mt-10 grid max-w-[1120px] gap-4 lg:grid-cols-3">
          {PILLARS.map((pillar) => (
            <StaggerItem key={pillar.number}>
              <article className="group h-full rounded-[18px] border border-white/15 bg-[#10225d] p-6 transition duration-300 hover:-translate-y-1 hover:border-gold-300/40">
                ...
                <p className="mt-3 text-[0.95rem] leading-[1.65] text-[#c6cada]">
                  {pillar.description}
                </p>
              </article>
            </StaggerItem>
